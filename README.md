...
This folder implements the agreed plan as **actionable deliverables**: content guidelines, sample copy, a placeholder logo asset, hosting selection steps, a developer brief, and a feature list for scoping. It also covers **YouTube embeds** and a **weekly editor workflow** to swap featured videos without code changes.
...
1. Replace placeholder Tamil and English copy in `content/` with your final text.
2. Complete the checklists in `docs/02` and `docs/04` with your real domain and priorities.
3. Send `docs/03-developer-brief.md` to shortlisted developers with your completed feature list.
4. To publish on WordPress.com yourself, follow [docs/06-wordpress-com-go-live.md](docs/06-wordpress-com-go-live.md).
5. To use **API tokens** and local scripts (so Cursor can help without your password), follow [docs/07-enable-automation-wordpress.md](docs/07-enable-automation-wordpress.md) and [scripts/README.md](scripts/README.md).
6. For **AI-maintained theme code** on WordPress.com, prefer **GitHub Deployments** — see [docs/08-maintain-code-github-vs-alternatives.md](docs/08-maintain-code-github-vs-alternatives.md).
